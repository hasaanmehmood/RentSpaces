            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4" style="background: #0000002e;">
                    	 <h1 style="margin-top: -300px;" class="text-uppercase text-white font-weight-bold">Rent</h1>
		...
		<div class="container">	
				<div class="col-lg-12">	
						...
						<?php 
						 ...
						 $cat = $conn->query("SELECT * FROM spaces");
						$cat_arr = array();
						...
						<div class="card item-rooms mb-3">
							<div class="card-body">
								...
								<div class="col-md-5" height="100%">
									...
									<h6><b>
										<?php echo $cat_arr[$row['category_id']]['Address'] ?>
									</b></h4>
									<h6><b>
										<?php echo $cat_arr[$row['category_id']]['City'] ?>
									</b></h4>
									<h6><b>
									<span> Rooms: </span><?php echo $cat_arr[$row['category_id']]['Room_No'] ?>
									</b></h4>
									<h6><b>
									<span> Baths </span><?php echo $cat_arr[$row['category_id']]['Bath_No'] ?>
									</b></h4>
									
							</br>
							        <h6><b>
									<span> Host: </span><?php echo $cat_arr[$row['category_id']]['Host_Name'] ?>
									</b></h6>
									<h6><b>
									<span> Contact: </span><?php echo $cat_arr[$row['category_id']]['Host_Contact'] ?>
									</b></h6>

									<div class="align-self-end mt-5">
										<button class="btn btn-dark  float-right book_now" type="button" data-id="<?php echo $row['category_id'] ?>">Book now</button>
									</div>
								</div>
							</div>
