...
<style>
	nav#sidebar {
    background: url("../assets/img/Greetings.png");
...
<nav id="sidebar" class='mx-lt-5' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=spaces" class="nav-item nav-categories"><span class='icon-field'><i class="fa fa-list"></i></span> Spaces </a>
				<a href="index.php?page=rooms" class="nav-item nav-rooms"><span class='icon-field'><i class="fa fa-bed"></i></span> Approve Spaces </a>
