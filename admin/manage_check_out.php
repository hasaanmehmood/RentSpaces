...
if($_GET['id']){
	...
	$cat = $conn->query("SELECT * FROM spaces where id =".$room['category_id'])->fetch_array();
}else{
	$cat = $conn->query("SELECT * FROM spaces where id =".$booked_cid)->fetch_array();
...
<div class="container-fluid">
	...
	<p><b>Room Description : </b><?php echo $cat['name'] ?></p>
